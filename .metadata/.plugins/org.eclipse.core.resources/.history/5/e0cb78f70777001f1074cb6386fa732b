...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		String stationname = "RAMPALLI";
		
		Area[] area = binarySearch(arr, stationname);
	...
	private static Area[] binarySearch(Area[] area, String stationname) {
	...
	public static Area[] createObject() {
		...
		Area a3 = new Area("S3", "EDAGAPLLI", 28.97, "COLORLESS", 7.89, 348.62, 0.81);
		...
		Area a6 = new Area("S6", "MELAPATULA", 29.50, "COLORLESS", 7.40, 75.20, 1.71);
